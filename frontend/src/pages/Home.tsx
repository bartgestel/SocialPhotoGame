          ...
          <div className="max-w-4xl mx-auto p-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="bg-tertiary rounded-xl overflow-hidden">
                <div 
                  onClick={() => navigate("/overview/1")}
                  className="aspect-[3/4] bg-gray-200 flex items-center justify-center cursor-pointer hover:opacity-90 transition-opacity"
                >
                ...
                <div className="p-4 flex gap-4 justify-center">
                  <button onClick={() => navigate("/edit/1")} className="p-2 hover:bg-white/50 rounded-full">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                  </button>
                  <button onClick={() => navigate("/overview/1")} className="p-2 hover:bg-white/50 rounded-full">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
